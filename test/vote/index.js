...
describe("vote.js", function () {
  ...
  describe("#createVote", function () {
    var createVote = vote.createVote,
      vt = null,
      publicKey = qzeonjs.crypto.getKeys("secret").publicKey,
    ...
    it("should create vote from ecpair", function () {
      ...
      var secondSecretKey = qzeonjs.ECPair.fromSeed("second secret");
    ...
    it("should be deserialised correctly", function () {
      var deserialisedTx = qzeonjs.crypto.fromBytes(qzeonjs.crypto.getBytes(vt).toString("hex"));
    ...
    describe("returned vote", function () {
      ...
      it("should have recipientId string equal to sender", function () {
        (vt).should.have.property("recipientId").and.be.type("string").and.equal(qzeonjs.crypto.getAddress(publicKey))
      });
      ...
      it("should be signed correctly", function () {
        var result = qzeonjs.crypto.verify(vt);
        (result).should.be.ok;
      });

      it("should be second signed correctly", function () {
        var result = qzeonjs.crypto.verifySecondSignature(vt, qzeonjs.crypto.getKeys("second secret").publicKey);
        (result).should.be.ok;
      });
